...
class AdminPageConfigBuilder {
    ...
    public function build(): array {
        ...
        $customPrompt = get_option('geweb_aisearch_custom_prompt', '');
        $customPromptName = get_option('geweb_aisearch_custom_prompt_name', '');
        $modelPromptOverrides = get_option('geweb_aisearch_model_prompts', []);
        $modelPromptOverrideNames = get_option('geweb_aisearch_model_prompt_names', []);
        $modelPromptOverrideModes = get_option('geweb_aisearch_model_prompt_modes', []);
        ...
        $promptHistoryLimit = (int) get_option('geweb_aisearch_prompt_history_limit', 10);
        $promptHistory = PromptSupport::normalizePromptHistoryEntries(get_option('geweb_aisearch_prompt_history', []));
